...
target 'music' do
  ...
  #用户详情头部视图
  # pod 'JXPagingView/Pager','1.1.1'
  
  # swift版本
  # https://github.com/pujiaxin33/JXPagingView
  pod 'JXPagingView/Paging','1.1.1'
  ...
  pod 'JXCategoryView','1.3.0'
  
  # swift版本
  #  pod 'JXSegmentedView','0.0.8'
  ...
  # 图片选择
  # https://github.com/Mark-Ma-1988/PhotoSolution
  pod 'PhotoSolution','1.5.8'
  ...
  #高德地图定位
  #https://lbs.amap.com/api/ios-location-sdk/gettingstarted
  ...
  #腾讯Bugly
  #https://bugly.qq.com/docs/user-guide/instruction-manual-ios/
  pod 'Bugly','2.5.0'
  
  #极光分析
  #http://docs.jiguang.cn/janalytics/client/ios_guide/
